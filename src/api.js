...
export const gameDetailsURL = (game_id) => `${base_url}games?key=${process.env.REACT_APP_API_KEY}&${game_id}`;
export const gameScreenshotURL = (game_pk) => `${base_url}games?key=${process.env.REACT_APP_API_KEY}&${game_pk}/screenshots`;